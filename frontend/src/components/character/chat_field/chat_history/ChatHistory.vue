...
import {nextTick, onBeforeMount, onMounted, useTemplateRef} from "vue";
...
<template>
  <div ref="scroll-ref" class="absolute top-18 left-2 w-86 h-112 overflow-y-scroll no-scrollbar">
